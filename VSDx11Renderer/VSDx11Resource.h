...
namespace VSEngine2
{
	...
	public:
		...
		ID3D11RasterizerState* m_pRasterState;  //顶点渲染器
	...
	public:
		...
		ID3D11DepthStencilState* m_pDepthStencilState;  //顶点渲染器
	...
	public:
		...
		ID3D11VertexShader*      m_pVertexShader;  //顶点渲染器
	...
	public:
		...
		ID3D11PixelShader*      m_pPixelShader;  //像素渲染器
		ID3D11Buffer*			m_pShaderBuffer;
	};
	...
	public:
		...
		ID3D11GeometryShader*      m_pGeometryShader;  //像素渲染器
		ID3D11Buffer*			m_pShaderBuffer;
	};
	...
	public:
		...
		ID3D11DomainShader*      m_pDomainShader;  //像素渲染器
		ID3D11Buffer*			m_pShaderBuffer;
	};
	...
	public:
		...
		ID3D11HullShader*      m_pHullShader;  //像素渲染器
		ID3D11Buffer*			m_pShaderBuffer;
	};
// 
